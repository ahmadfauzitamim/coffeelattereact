...
const ProductDetail = () => {
  ...
  return (
    <div>
      <Navbar />
      {
        isLoading ? <div className='h-1/2 w-1/2 text-orange-500 animate-spin flex items-center justify-center' ><RiLoader2Fill/></div> :
              ...
              <div className=" bg-white flex flex-col items-center p-16 justify-between rounded-3xl">
                <div className="flex flex-col text-left  gap-16 ">
                  <div className="flex flex-col gap-8 text-xl">
                    <p>Delivery only on <span className='font-bold text-orange-900'>Monday to</span>  <span className='font-bold text-orange-900'> <br />friday</span> at <span  className='font-bold text-orange-900'>1 - 7 pm</span></p>
