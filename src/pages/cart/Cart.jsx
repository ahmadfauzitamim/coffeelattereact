    ...
    <div>
      ...
      <div className='bg-[#EFEEEE]'>
        <div className='px-28 py-14 gap-12 justify-start'>
          ...
          <div className='grid grid-rows-2 grid-flow-col gap-x-10 gap-y-4 justify-between'>
            ...
            <div className='justify-center'>
              <button className='items-start w-[450px] h-[80px] bg-[#FFBA33] rounded-2xl text-white font-bold'>Confirm and Pay</button>
            </div>
          </div>
        </div>
      </div>
